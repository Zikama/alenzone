...
<body class=" flex-wrap align-content-around" style="display:initial">
    <!--required for getting the stripe token d-flex-->
    <?php
    ...
    ">
            ...
            <form method="post" action="<?php echo site_url('home/payment_success/stripe/' . $user_details['id'].'/'.$amount_to_pay);?>">
                <label>
        ...
        <script type="text/javascript">
            get_stripe_currency('<?php echo get_settings('
                stripe_currency '); ?>');
        </script>
