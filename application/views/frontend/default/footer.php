                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="copyright-text">
                            <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url() . 'uploads/system/logo-dark.png'; ?>" alt="" class="d-inline-block" width="110"></a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content payment-in-modal">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo get_phrase('pay_with'); ?>:</h5>
