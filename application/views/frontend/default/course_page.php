    ...
    <div class="row align-items-end">
      <div class="col-lg-8">
        <div class="course-header-wrap">
          ...
          <div class="rating-row remove_it" hidden>
          ...
          <div class="created-row">
            ...
            <?php endif; ?>
            <span class="comment remove_it" hidden><i class="fas fa-comment"></i><?php echo ucfirst($course_details['language']); ?></span>
          </div>
        </div>
      </div>
      <div class="col-lg-4">
    ...
    <div class="row">
      <div class="col-lg-8">
        ...
        <div class="compare-box view-more-parent">
          ...
          if (is_array($other_realted_courses) && count($other_realted_courses)) : ?>

            <div class="compare-title"><?php echo get_phrase('other_related_courses'); ?></div>
            <div class="compare-courses-wrap" style="background: white;">
              <?php
                  ...
                  <div class="course-comparism-item-container this-course">
                    <div class="course-comparism-item clearfix">
                      <div class="item-image float-left">
                        <a href="<?php echo site_url('home/course/' . slugify($other_realted_course['title']) . '/' . $other_realted_course['id']); ?>"><img src="<?php echo $this->crud_model->get_course_thumbnail_url($other_realted_course['id']); ?>" alt="" class="img-fluid"></a>
                        <div class="item-duration remove_it" hidden><b><?php echo $this->crud_model->get_total_duration_of_lesson_by_course_id($other_realted_course['id']); ?></b></div>
                      </div>
                      ...
                      <div class="item-details float-left">
                        <span class="item-rating remove_it" hidden>
                          <i class="fas fa-star"></i>
                          <?php
                        ...
                        <span class="enrolled-student remove_it" hidden>
        ...
        <div class="about-instructor-box">
          <div class="about-instructor-title remove_it" hidden>
            <?php echo get_phrase('about_the_instructor'); ?>
          </div>
          <div class="row remove_it" hidden>
            <div class="col-lg-4">
        ...
        <div class="student-feedback-box">
          <div class="student-feedback-title remove_it" hidden>
          ...
          <div class="course-sidebar-text-box">
            <div class="price">
              ...
              <?php else : ?>
                ...
                <?php else : ?>
                  <span class="current-price"><span class="current-price"><?php echo currency($course_details['price']); ?></span>
            ...
            <?php else : ?>
              ...
              <?php else : ?>
                <div class="buy-btns">
                  ...
                  <a href="javascript::" class="btn btn-buy-now" id="course_<?php echo $course_details['id']; ?>" onclick="handleCheckOut()"><?php echo get_phrase('enroll_now'); ?>
                  </a>

                  <?php
                      /*
                   if (in_array($course_details['id'], $this->session->userdata('cart_items'))) : ?>
                  ...
                  <?php else : ?>
                    <button class="btn btn-add-cart" type="button" id="<?php echo $course_details['id']; ?>" onclick="(this)"><?php echo get_phrase('add_to_cart'); ?></button>
                  <?php endif; */ ?>
                </div>
              <?php endif; ?>
            <?php endif; ?>
...
<script>
  var __remove_it = document.getElementsByClassName('remove_it');

  if (__remove_it.length) {
    for (let index = 0; index < __remove_it.length; index++) {
      const remove_it = __remove_it[index];
      if (remove_it)
        remove_it.remove();
    }
  }
    ...
    $.ajax({
      ...
      success: function(response) {
        if (!response) {
          ...
          $('.total_price_of_checking_out').val($('#total_price_of_checking_out').val().replace('$', ''));
        }
      }
    });
  }
