<section class="category-course-list-area">
    <div class="container">
        <div class="row justify-content-center art_gradient_light_grey ">
            <div class="col-lg-9">
                <div class="user-dashboard-box mt-3">
                    <div class="user-dashboard-content w-100 login-form">
                        ...
                        <form action="<?php echo site_url('login/validate_login/user'); ?>" method="post">
                            ...
                            <div class="forgot-pass text-center">
                                <span>or</span>
                                <a href="javascript:void(0)" onclick="toggoleForm('forgot_password')"><?php echo get_phrase('forgot_password'); ?></a>
                            </div>
                            <div class="account-have text-center">
                                <?php echo get_phrase('do_not_have_an_account'); ?><span class="art_custom_font">?</span> <a href="javascript:void(0)" onclick="toggoleForm('registration')"><?php echo get_phrase('sign_up'); ?></a>
                            </div>
                        </form>
                    </div>
                    <div class="user-dashboard-content w-100 register-form hidden">
                        ...
                        <form action="<?php echo site_url('login/register'); ?>" method="post">
                            ...
                            <div class="account-have text-center">
                                <?php echo get_phrase('already_have_an_account'); ?><span class="art_custom_font">?</span> <a href="javascript:void(0)" onclick="toggoleForm('login')"><?php echo get_phrase('login'); ?></a>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="user-dashboard-content w-100 forgot-password-form hidden">
                        ...
                        <form action="<?php echo site_url('login/forgot_password/frontend'); ?>" method="post">
                            ...
                            <div class="forgot-pass text-center">
                                <?php echo get_phrase('want_to_go_back'); ?><span class="art_custom_font"><span class="art_custom_font">?</span></span> <a href="javascript:void(0)" onclick="toggoleForm('login')"><?php echo get_phrase('login'); ?></a>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    function toggoleForm(form_type) {
        ...
        if (form_type === 'login') {
            $('.login-form').show().removeClass('hidden');
            $('.forgot-password-form').hide().addClass('hidden');
            $('.register-form').hide().addClass('hidden');
        } else if (form_type === 'registration') {
            $('.login-form').hide().addClass('hidden');
            $('.forgot-password-form').hide().addClass('hidden');
            $('.register-form').show().removeClass('hidden');
        } else if (form_type === 'forgot_password') {
            $('.login-form').hide().addClass('hidden');
            $('.forgot-password-form').show().removeClass('hidden');
            $('.register-form').hide().addClass('hidden');
        }
    }
</script>