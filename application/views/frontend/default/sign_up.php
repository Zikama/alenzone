                ...
                <div class="user-dashboard-box mt-3">
                    <div class="user-dashboard-content w-100 login-form hidden">
                        ...
                        <form action="<?php echo site_url('login/validate_login/user'); ?>" method="post">
                            ...
                            <div class="account-have text-center">
                                <?php echo get_phrase('do_not_have_an_account'); ?>? <a href="javascript:void(0)" onclick="toggoleForm('registration')"><?php echo get_phrase('sign_up'); ?></a>
                            </div>
                        </form>
                    </div>
                    <div class="user-dashboard-content w-100 register-form">
                        ...
                        <form action="<?php echo site_url('login/register'); ?>" method="post">
                            ...
                            <div class="account-have text-center">
                                <?php echo get_phrase('already_have_an_account'); ?>? <a href="<?php echo base_url('home/login') ?>" onclick="toggoleForm('login')"><?php echo get_phrase('login'); ?></a>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="user-dashboard-content w-100 forgot-password-form hidden">
                        ...
                        <form action="<?php echo site_url('login/forgot_password/frontend'); ?>" method="post">
                            ...
                            <div class="forgot-pass text-center">
                                <?php echo get_phrase('want_to_go_back'); ?>? <a href="javascript:void(0)" onclick="toggoleForm('login')"><?php echo get_phrase('login'); ?></a>
                            </div>
                        </form>
                    </div>
                </div>
