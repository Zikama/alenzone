...
<div class="row ">
  <div class="col-xl-12">
    <div class="card">
      <div class="card-body">
        <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('theme_settings'); ?></h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
</div>
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="header-title mb-3"><?php echo get_phrase('themes_section'); ?></h4>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="premium_themes">

            <!-- listing premium themes -->
            <div style="overflow: hidden; margin: 15px auto; width:100%; height:1600px;">
              <iframe scrolling="yes" src="http://academy-lms.com/academy-themes/index.php" style="border: 0px none; width: 100%; height:100%;">
              </iframe>
            </div>
            <!-- listing premium themes -->
