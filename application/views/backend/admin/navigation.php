...
<div class="left-side-menu left-side-menu-detached">
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<li class="side-nav-item">
			...
			<ul class="side-nav-second-level" aria-expanded="false">
				<li class="<?php if ($page_name == 'create_post') echo 'active'; ?>"> <a href="<?php echo site_url('admin/news/create_post'); ?>"><?php echo get_phrase('create_a_new_post'); ?></a> </li>
				<?php if (get_settings('allow_instructor') == 1) : ?>
					<li class="<?php if ($page_name == 'instructor_create_post') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/instructor_create_post'); ?>">
							<?php echo get_phrase('instructor_create_post'); ?>
						</a>
					</li>
				<?php endif; ?>
			</ul>
