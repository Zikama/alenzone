    ...
    <div class="col-xl-8">
        <div class="row">
            <style>
                ...
                .art_hooved_over:hover .art_hooved {
                    display: initial;
                    position: absolute;
                    top: 35px;
                    z-index: 11;
            ...
            foreach ($sections as $key => $section) : ?>
                <div class="col-xl-12">
                    ...
                    <div class="card bg-light text-seconday on-hover-action mb-5 art_hooved_over">
                        <div class="card-body">
                            <h5 class="card-title" class="mb-3" style="min-height: 35px;"><span class="font-weight-light"><?php echo get_phrase('section') . ' ' . ++$key; ?></span>: <?php echo $section['title']; ?>
                                <div class="row art_hooved" id="widgets-of-section-<?php echo $section['id']; ?>">
